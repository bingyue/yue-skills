---
name: markdown-html-wechat
description: Converts Markdown to styled HTML with WeChat-compatible themes. Supports code highlighting, math, PlantUML, footnotes, alerts, visual-infographic-generators, and optional bottom citations for external links. Use when user asks for "markdown to html", "convert md to html", "md 转 html", "微信外链转底部引用", or needs styled HTML output from markdown.
version: 1.56.1
metadata:
  openclaw:
    requires:
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.yue-skills/markdown-html-wechat/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/yue-skills/markdown-html-wechat/EXTEND.md` | XDG |
| 3 | `$HOME/.yue-skills/markdown-html-wechat/EXTEND.md` | User home |
...
If CJK content detected AND `markdown-format-polish` skill is available:
...
**If user agrees**: Invoke `markdown-format-polish` skill to format the file, then use formatted file as input.
...
3. `publish-wechat-official` EXTEND.md `default_theme` (cross-skill fallback)
...
Read `$HOME/.yue-skills/publish-wechat-official/EXTEND.md` if it exists and look for a `default_theme:` line. Use the value if present; otherwise fall through.
