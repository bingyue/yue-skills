...
description: First-time setup flow for web-markdown-extract preferences
---
...
options:
  - label: "web-markdown-extract (Recommended)"
    description: "Save to ./web-markdown-extract/{domain}/{slug}.md"
```
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `~/.yue-skills/web-markdown-extract/EXTEND.md` | All projects |
| Project | `.yue-skills/web-markdown-extract/EXTEND.md` | Current project |
