...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.yue-skills/wechat-group-summary/EXTEND.md` (relative to project root) | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/yue-skills/wechat-group-summary/EXTEND.md` | XDG |
| 3 | `$HOME/.yue-skills/wechat-group-summary/EXTEND.md` | User home |
