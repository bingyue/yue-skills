...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.yue-skills/image-compress-optimizer/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/yue-skills/image-compress-optimizer/EXTEND.md` | XDG |
| 3 | `$HOME/.yue-skills/image-compress-optimizer/EXTEND.md` | User home |
