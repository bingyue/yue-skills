...
Deep analysis framework applying instructional design principles to visual-infographic-generator creation.

## Purpose

Before creating an visual-infographic-generator, thoroughly analyze the source material to:
...
| **Journey/Narrative** | Stories, user flows, milestones | winding-roadmap, story-mountain | storybook-watercolor, content-comic-generator-strip |
...
Every visual-infographic-generator should have 1-3 clear learning objectives.
...
**Format**: "After viewing this visual-infographic-generator, the viewer will understand..."
...
## Learning Objectives
After viewing this visual-infographic-generator, the viewer should understand:
1. [Primary objective]
