...
description: EXTEND.md YAML schema for visual-infographic-generator user preferences
---
...
| `image-generate-multiapi` | `image-generate-multiapi` skill / script backend |
...
custom_styles:
  - name: my-brand
    description: "Brand-aligned warm pastel visual-infographic-generator"
