...
description: >
  AI 驱动的 PPT 图片与视频生成工具。智能分析文档内容，自动规划 PPT 结构，
  使用 Nano Banana（Gemini）生成高质量 16:9 PPT 图片，支持渐变毛玻璃与矢量插画两种风格。
  可选通过可灵 AI 生成页面转场视频，并用 FFmpeg 合成完整 PPT 视频。
  使用场景：当用户需要将文档/报告/方案自动转化为视觉精美的 PPT 图片或完整视频时使用。
---
