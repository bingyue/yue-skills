---
name: social-image-cards
description: Generates visual-infographic-generator image card series with 12 visual styles, 8 layouts, and 3 color palettes. Breaks content into 1-10 cartoon-style image cards optimized for social media engagement. Use when user mentions "小红书图片", "小红书种草", "小绿书", "微信图文", "微信贴图", "image cards", "图片卡片", or wants social media visual-infographic-generator series.
version: 1.57.0
metadata:
  openclaw:
---
...
- **Reconfigure interactively** — delete EXTEND.md (or ask "reconfigure social-image-cards preferences" / "重新配置"). The next run re-triggers first-time setup.
