...
Every XHS visual-infographic-generator prompt follows this structure:

```
Create a Xiaohongshu (Little Red Book) style visual-infographic-generator following these guidelines:
...
Please use nano banana pro to generate the visual-infographic-generator based on the specifications above.
```
