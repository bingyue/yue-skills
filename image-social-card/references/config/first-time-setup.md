...
description: First-time setup flow for xhs-cards-legacy preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.yue-skills/xhs-cards-legacy/EXTEND.md` | Current project |
| User | `~/.yue-skills/xhs-cards-legacy/EXTEND.md` | All projects |
