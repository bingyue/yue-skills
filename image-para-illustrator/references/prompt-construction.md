...
```
Single-page hand-drawn educational visual-infographic-generator in a clean presentation style.
...
```
Flat vector illustration visual-infographic-generator. Clean black outlines on all elements.
