...
${BUN_X} {baseDir}/scripts/main.ts <url> --text-translate-workflow zh-Hans
...
| `--text-translate-workflow <code>` | Translate to specified language code | |
...
| `--output-dir <dir>` | Base output directory | `youtube-transcript-extract` |
