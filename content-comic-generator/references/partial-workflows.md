...
```bash
/content-comic-generator content.md --storyboard-only
```
...
```bash
/content-comic-generator content.md --prompts-only
```
...
```bash
/content-comic-generator content-comic-generator/topic-slug/ --images-only
```
...
```bash
# Single page
/content-comic-generator content-comic-generator/topic-slug/ --regenerate 3

# Multiple pages
/content-comic-generator content-comic-generator/topic-slug/ --regenerate 2,5,8

# Cover page
/content-comic-generator content-comic-generator/topic-slug/ --regenerate 0
```
...
**Use case**: Fix specific pages without regenerating entire content-comic-generator. Useful for:
