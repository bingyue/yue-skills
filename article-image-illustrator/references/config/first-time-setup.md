...
description: First-time setup flow for article-image-illustrator preferences
---
...
options:
  - label: "sketch-notes (Recommended)"
    description: "Warm cream paper, black hand-drawn lines, soft pastel blocks — educational visual-infographic-generator feel. Great default for most articles."
  - label: "None"
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.yue-skills/article-image-illustrator/EXTEND.md` | Current project |
| User | `~/.yue-skills/article-image-illustrator/EXTEND.md` | All projects |
