...
When content analysis surfaces no strong signal (generic knowledge article, mixed-topic post, no clear data/comparison/narrative cue), recommend **`hand-drawn-edu`** as the primary option in Step 3 Q1. It is the warm, friendly educational-visual-infographic-generator default — safe for most articles and universally readable.
...
|----------|------|-------|---------|----------|
| `tech-explainer` | `visual-infographic-generator` | `blueprint` | — | API docs, system metrics, technical deep-dives |
...
| `science-paper` | `visual-infographic-generator` | `scientific` | — | Research findings, lab results, academic |

### Knowledge & Education

| --preset | Type | Style | Palette | Best For |
|----------|------|-------|---------|----------|
| `knowledge-base` | `visual-infographic-generator` | `vector-illustration` | — | Concept explainers, tutorials, how-to |
| `saas-guide` | `visual-infographic-generator` | `notion` | — | Product guides, SaaS docs, tool walkthroughs |
...
| `warm-knowledge` | `visual-infographic-generator` | `vector-illustration` | `warm` | Product showcases, team intros, feature cards, brand content |
| `edu-visual` | `visual-infographic-generator` | `vector-illustration` | `macaron` | Knowledge summaries, concept explainers, educational articles |
| `hand-drawn-edu` | `visual-infographic-generator` | `sketch-notes` | `macaron` | **Default preset.** Hand-drawn educational visual-infographic-generator — warm cream paper, black lines, pastel blocks. Great for single-page explainers, concept summaries, onboarding, general knowledge articles |
...
| --preset | Type | Style | Palette | Best For |
|----------|------|-------|---------|----------|
| `data-report` | `visual-infographic-generator` | `editorial` | — | Data journalism, metrics reports, dashboards |
...
- `--preset tech-explainer --style notion` = visual-infographic-generator type with notion style
