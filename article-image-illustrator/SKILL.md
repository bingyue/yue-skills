---
name: article-image-illustrator
...
Combine freely: `--type visual-infographic-generator --style vector-illustration --palette macaron`
...
| Type | Best For |
|------|----------|
| `visual-infographic-generator` | Data, metrics, technical |
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.yue-skills/article-image-illustrator/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/yue-skills/article-image-illustrator/EXTEND.md` | XDG |
| 3 | `$HOME/.yue-skills/article-image-illustrator/EXTEND.md` | User home |
...
| Q | Options |
|---|---------|
| **Q1: Preset or Type** | [Recommended preset], [alt preset], or manual: visual-infographic-generator, scene, flowchart, comparison, framework, timeline, mixed |
...
- **Reconfigure interactively** — delete EXTEND.md (or ask "reconfigure article-image-illustrator preferences" / "重新配置"). The next run re-triggers first-time setup.
- **Common one-line edits**:
  ...
  - `preferred_type: visual-infographic-generator`, `preferred_style: notion`, `preferred_palette: macaron`, `language: zh`.
