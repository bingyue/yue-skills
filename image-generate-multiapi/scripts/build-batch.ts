...
Options:
  ...
  --provider <name>    Provider for image-generate-multiapi batch tasks (default: replicate)
  --model <id>         Explicit model for image-generate-multiapi batch tasks (default: resolved by image-generate-multiapi config/env)
