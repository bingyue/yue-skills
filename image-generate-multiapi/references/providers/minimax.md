...
- Official docs say `image_file` supports public URLs or Base64 Data URLs; image-generate-multiapi sends local refs as Data URLs
- Recommended refs: front-facing portraits, JPG/JPEG/PNG, under 10MB

## Official References

- [Image Generation Guide](https://platform.minimaxi.com/docs/guides/image-generate-legacyeration)
- [Text-to-Image API](https://platform.minimaxi.com/docs/api-reference/image-generate-legacyeration-t2i)
- [Image-to-Image API](https://platform.minimaxi.com/docs/api-reference/image-generate-legacyeration-i2i)
