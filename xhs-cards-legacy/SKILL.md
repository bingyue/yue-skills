---
name: xhs-cards-legacy
description: "[Deprecated: use social-image-cards] Generates Xiaohongshu (Little Red Book) image card series with 12 visual styles, 8 layouts, and 3 color palettes. Breaks content into 1-10 cartoon-style image cards optimized for XHS engagement. Use when user mentions \"小红书图片\", \"XHS images\", \"RedNote visual-infographic-generators\", \"小红书种草\", \"小绿书\", \"微信图文\", \"微信贴图\", or wants social media visual-infographic-generator series for Chinese platforms."
version: 1.57.0
metadata:
  openclaw:
---
...
| `sketch-notes` | Hand-drawn educational visual-infographic-generator, macaron pastels on warm cream, wobble lines |
...
| hand-drawn, visual-infographic-generator, workflow, 手绘, 图解 | `sketch-notes` | flow/balanced/dense | `hand-drawn-edu`, `sketch-card`, `sketch-summary` |
...
| Path | Scope |
|------|-------|
| `.yue-skills/social-image-cards/EXTEND.md` | Project |
| `${XDG_CONFIG_HOME:-$HOME/.config}/yue-skills/social-image-cards/EXTEND.md` | XDG |
| `$HOME/.yue-skills/social-image-cards/EXTEND.md` | User home |
...
- **Reconfigure interactively** — delete EXTEND.md (or ask "reconfigure xhs-cards-legacy preferences" / "重新配置"). The next run re-triggers first-time setup.
