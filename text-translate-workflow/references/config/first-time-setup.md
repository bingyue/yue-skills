...
description: First-time setup flow for text-translate-workflow preferences
---
...
options:
  - label: "Normal (Recommended)"
    description: "Analyze content first, then text-translate-workflow"
  - label: "Quick"
    description: "Direct translation, no analysis"
  - label: "Refined"
    description: "Full workflow: analyze → text-translate-workflow → review → polish"
```
...
options:
  - label: "User (Recommended)"
    description: "$HOME/.yue-skills/ (all projects)"
  - label: "Project"
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `$HOME/.yue-skills/text-translate-workflow/EXTEND.md` | All projects |
| Project | `.yue-skills/text-translate-workflow/EXTEND.md` | Current project |
