...
Terms where standard translation is non-obvious or easily mistext-translate-workflowd. Common terms with straightforward translations (e.g., Machine Learning → 机器学习) are omitted — the model already knows these.
