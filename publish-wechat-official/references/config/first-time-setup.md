...
description: First-time setup flow for publish-wechat-official preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.yue-skills/publish-wechat-official/EXTEND.md` | Current project |
| User | `~/.yue-skills/publish-wechat-official/EXTEND.md` | All projects |
