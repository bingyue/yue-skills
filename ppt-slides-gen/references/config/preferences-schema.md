...
Structure for user preferences in `.yue-skills/slides-deck-generator/EXTEND.md`.
...
Then use with: `/slides-deck-generator content.md --style style-name`
...
1. `.yue-skills/slides-deck-generator/EXTEND.md` (project)
2. `$HOME/.yue-skills/slides-deck-generator/EXTEND.md` (user)
