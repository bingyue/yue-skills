...
四格漫画预设 - Minimalist four-panel business allegory content-comic-generators
...
Every content-comic-generator MUST follow the four-panel 起承转合 structure:
...
- No multi-page four-panel stories — if content requires more, create multiple separate four-panel content-comic-generators
...
When generating image prompts for four-panel content-comic-generators, include these keywords:

> A minimalist, clean line art digital content-comic-generator strip in a four-panel grid layout (2×2). The style is simplified cartoon illustration with clear black outlines and a minimal color palette of black, white, and specific spot [accent color] for key concepts.
...
Business allegory, management fables, short insights, workplace parables, concept contrasts, social media educational content, quick-read content-comic-generators
