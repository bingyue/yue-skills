...
Before creating a content-comic-generator, thoroughly analyze the source material to:
- Identify the target audience and their needs
- Determine what value the content-comic-generator will deliver
...
- Which examples text-translate-workflow well to visual panels?
...
- Should the content-comic-generator challenge or reinforce these?

### 3. Audience Analysis

**Primary Audience**
- Who will read this content-comic-generator?
- What is their existing knowledge level?
- What are their interests and motivations?

**Secondary Audiences**
- Who else might benefit from this content-comic-generator?
...
| `user_language` | Output language for content-comic-generator (from EXTEND.md > --lang > source_language) |
...
- [ ] Do I know exactly who will read this content-comic-generator?
- [ ] Have I identified at least 3 ways this content-comic-generator provides value?
