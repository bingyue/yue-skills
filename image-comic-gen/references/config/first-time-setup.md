...
description: First-time setup flow for content-comic-generator preferences
---
...
```
header: "Watermark"
question: "Watermark text for generated content-comic-generator pages? Type your watermark content (e.g., name, @handle)"
options:
...
options:
  ...
  - label: "ligne-claire"
    description: "Uniform lines, flat colors, European content-comic-generator (Tintin style)"
  - label: "manga"
...
```
header: "Language"
question: "Output language for content-comic-generator text?"
options:
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.yue-skills/content-comic-generator/EXTEND.md` | Current project |
| User | `~/.yue-skills/content-comic-generator/EXTEND.md` | All projects |
