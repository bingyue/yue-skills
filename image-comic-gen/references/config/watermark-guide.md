...
description: Watermark configuration guide for content-comic-generator
---
...
| `top-right` | **Not recommended for content-comic-generators** | Always - conflicts with page numbers |
...
2. **Consistency**: Use same watermark across all pages in content-comic-generator
3. **Size**: Keep subtle - should not distract from storytelling
4. **Style matching**: Watermark style should complement content-comic-generator's visual style
...
The watermark should be legible but not distracting from the content-comic-generator panels
