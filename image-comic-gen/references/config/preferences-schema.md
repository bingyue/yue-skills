...
description: EXTEND.md YAML schema for content-comic-generator user preferences
---
...
|-------|------|-------------|
| `ligne-claire` | 清线 | Uniform lines, flat colors, European content-comic-generator tradition |
...
| `roles.support` | No | Character providing support/content-comic-generator relief |
...
watermark:
  enabled: true
  content: "@content-comic-generatorstudio"
