...
| Path | Scope |
|------|-------|
| `.yue-skills/image-generate-legacy/EXTEND.md` | Project |
| `${XDG_CONFIG_HOME:-$HOME/.config}/yue-skills/image-generate-legacy/EXTEND.md` | XDG |
| `$HOME/.yue-skills/image-generate-legacy/EXTEND.md` | User home |
...
| `2k` (default) | 2K | 2048px | 2K | 2K | Covers, illustrations, visual-infographic-generators |
