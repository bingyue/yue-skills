...
- Text-to-image only in image-generate-multiapi (no `--ref` support yet)
...
- The sync API returns a temporary URL; image-generate-multiapi downloads it and writes locally
