...
- macOS: `~/Library/Application Support/yue-skills/gemini-web/consent.json`
- Linux: `~/.local/share/yue-skills/gemini-web/consent.json`
- Windows: `%APPDATA%\yue-skills\gemini-web\consent.json`
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.yue-skills/danger-gemini-webapi/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/yue-skills/danger-gemini-webapi/EXTEND.md` | XDG |
| 3 | `$HOME/.yue-skills/danger-gemini-webapi/EXTEND.md` | User home |
