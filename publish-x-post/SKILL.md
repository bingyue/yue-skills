...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.yue-skills/publish-x-post/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/yue-skills/publish-x-post/EXTEND.md` | XDG |
| 3 | `$HOME/.yue-skills/publish-x-post/EXTEND.md` | User home |
...
| Profile dir | Shared profile at `yue-skills/chrome-profile` (see CLAUDE.md Chrome Profile section) |
