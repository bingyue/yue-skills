...
```bash
# macOS
cat ~/Library/Application\ Support/yue-skills/x-to-markdown/consent.json

# Linux
cat ~/.local/share/yue-skills/x-to-markdown/consent.json
```
...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.yue-skills/danger-x-markdown-export/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/yue-skills/danger-x-markdown-export/EXTEND.md` | XDG |
| 3 | `$HOME/.yue-skills/danger-x-markdown-export/EXTEND.md` | User home |
