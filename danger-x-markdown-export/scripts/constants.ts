...
export const FALLBACK_TWEET_FEATURE_SWITCHES = [
  ...
  "responsive_web_grok_show_grok_text-translate-workflowd_post",
  ...
  "responsive_web_grok_image-generate-multiapi_annotation_enabled",
...
export const FALLBACK_TWEET_DETAIL_FEATURE_DEFAULTS: Record<string, boolean> = {
  ...
  responsive_web_grok_show_grok_text-translate-workflowd_post: false,
