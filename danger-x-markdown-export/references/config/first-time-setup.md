...
description: First-time setup flow for danger-x-markdown-export preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `~/.yue-skills/danger-x-markdown-export/EXTEND.md` | All projects |
| Project | `.yue-skills/danger-x-markdown-export/EXTEND.md` | Current project |
