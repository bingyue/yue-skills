...
| Priority | Path | Scope |
|----------|------|-------|
| 1 | `.yue-skills/markdown-format-polish/EXTEND.md` | Project |
| 2 | `${XDG_CONFIG_HOME:-$HOME/.config}/yue-skills/markdown-format-polish/EXTEND.md` | XDG |
| 3 | `$HOME/.yue-skills/markdown-format-polish/EXTEND.md` | User home |
