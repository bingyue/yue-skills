...
description: First-time setup flow for article-cover-generator preferences
---
...
options:
  - label: "Independent (Recommended)"
    description: "article-cover-generator/{topic-slug}/ - separate from article"
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.yue-skills/article-cover-generator/EXTEND.md` | Current project |
| User | `~/.yue-skills/article-cover-generator/EXTEND.md` | All projects |
