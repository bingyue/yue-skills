...
| Signals | Rendering |
|---------|-----------|
| Clean, modern, tech, WeChat, icon-based, visual-infographic-generator | `flat-vector` |
...
| Announcement, features, multiple points, visual-infographic-generator | `text-rich` |
